...
const leftImages = [
  { src: "/images/hero/maldives.jpg", alt: "Maldives" },
  { src: "/images/hero/kyoto.jpg", alt: "Kyoto" },
  { src: "/images/hero/switzerland.jpg", alt: "Switzerland" },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          <div className="mb-10">
            ...
            <p className="text-gray-500">Start planning your next adventure for free.</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-sm text-gray-400 font-medium">or sign up with email</span>
            </div>
          </div>
